...
def parsersers_():
    ...
    parser.add_argument('--num_neuron', type=int, default=64, help='num_neuron') #Number of neurons in first layer of MLPs inside of the GNN
    parser.add_argument('--num_feature_su','-su', type=int, default=8, help='num_feature_su') #Number of embedded features     
    parser.add_argument('--samples', type=int, default=1000000, help='train sample data') #Total number of training samples
    parser.add_argument('--batch_size', type=int, default=1000, help='batch_size') #Batch size
    parser.add_argument('--n_epochs','-ne', type=int, default=500, help='n_epochs') #Total number of training epochs
    
    parser.add_argument('--Nt', type=int, default=2, help='Nt') #Number of tranmitters
    parser.add_argument('--Nr', type=int, default=2, help='Nr') #Number of receivers
    
    parser.add_argument('--SNR_dB_min_train', type=int, default=20.0, help='SNR_dB_min') #Training SNR(dB)
    parser.add_argument('--SNR_dB_max_train', type=int, default=20.0, help='SNR_dB_max') #Training SNR(dB)
    parser.add_argument('--SNR_dB_min_test', type=int, default=20.0, help='SNR_dB_min_test') #Testing SNR(dB)
    parser.add_argument('--SNR_dB_max_test', type=int, default=20.0, help='SNR_dB_max_test') #Testing SNR(dB)
